...
WHYBAD: the numbered analysis, beginning directly with "1." (no "Analysis:" label, no surrounding brackets), of ONLY as many points as carry real substance (normally 3–5). Required, in order: 1. a verbatim quote and the claim it advances; 2. the named framing technique(s) or fallacy(ies) in plain English; 3. the concrete real-world harm it normalizes/justifies/hides. OPTIONAL: 4. a sentence beginning "External Context:" with a real, well-established rebutting fact stated GENERALLY — include ONLY if the entry genuinely has one, else omit; 5. where it genuinely applies, "Conflict of interest:" and/or "Timeliness note:". NEVER pad to a fixed count and NEVER write a filler placeholder point such as "5. No additional context", "None", or "N/A" — end at the last real point, and DELETE any such filler already in the entry. PRESERVE the depth and reasoning of the existing analysis — only restructure it into this numbered form and fix the problems below. Aim for 150–280 words.
...
- GENERALIZE every over-specific citation: replace statute/section numbers (e.g. "18 U.S.C. § 611"), specific case names, precise statistics/percentages, and specific study titles/dates with general assertions ("long-standing federal law already prohibits this"; "the same policy was tried before and produced the opposite result"; "the agency's own data contradicts this"). Keep only extremely well-known institution names you are sure of (ADA, OSHA, Civil Rights Act). When unsure, argue from the piece's own logic.
- STRIP VAGUE AUTHORITIES: remove every appeal to an unnamed source — "multiple news outlets reported", "studies show", "many experts agree", "research finds", "researchers found", "critics note", "reports indicate", "it is widely reported", "observers say" and the like. Replace each with a plainly-stated common fact in your own words, or an argument from the piece's own logic. If there is no real fact to substitute, delete the claim rather than leave the vague appeal.
...
- NO ALL-CAPS words or labels — rewrite any shouting capitals into normal case, and write labels in sentence case ("External Context:", "Conflict of interest:", "Timeliness note:"). Ordinary acronyms you are sure of (ADA, OSHA, EPA) are fine.

Return ONLY a raw JSON object: {"summary": "A single flowing paragraph with at least one verbatim quote.", "whyBad": "1. ... 2. ... 3. ... (optional 4. External Context: ... 5. ...) — end at the last real point, never pad"}`;
