...
const JSON_SCHEMA = `Return ONLY a raw JSON array (no markdown, no code blocks, no preamble):
[
  {
    "url": "https://...",
...
export const CATEGORIES: Category[] = [
  // ── Economic Ideology & Exploitation ────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find opinion pieces, strategy articles, business advice, and news that advocate for union avoidance, portray unions as harmful to workers or the economy, or frame union-busting tactics as worker empowerment.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'union_busting')}`,
  },
  {
    key: 'trickle_down',
    ...
    researchPrompt: `Use the research tool to find articles, op-eds, and think-tank pieces that uncritically advocate for supply-side economics, argue tax cuts for the wealthy pay for themselves, or frame billionaires as the engine of economic growth without acknowledging wage stagnation or inequality evidence.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'trickle_down')}`,
  },
  {
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'billionaire_worship')}`,
  },
  {
    ...
    researchPrompt: `Use the research tool to find articles and corporate PR that frame gig work misclassification (no benefits, no protections) as "freedom" and "flexibility" — while downplaying or ignoring the lack of healthcare, retirement, overtime protections, and the transfer of business risk onto workers.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'gig_exploitation')}`,
  },
  {
    key: 'poverty_blaming',
    ...
    researchPrompt: `Use the research tool to find articles, op-eds, and policy pieces that attribute poverty primarily to personal choices, lack of discipline, or cultural failings — while dismissing systemic factors like wage stagnation, housing costs, healthcare costs, inherited wealth gaps, and structural racism.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'poverty_blaming')}`,
  },
  {
    key: 'child_labor',
    name: 'Child Labor Normalization',
    description: 'Arguments for loosening child labor laws or framing child labor as beneficial',
    researchPrompt: `Use the research tool to find articles, think-tank pieces, and legislative commentary that argue for weakening child labor protections, frame child labor as "opportunity," or minimize documented harms of child labor — particularly in agriculture, meatpacking, or construction.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'child_labor')}`,
  },
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'race_science')}`,
  },
  {
    ...
    researchPrompt: `Use the research tool to find articles and opinion pieces that invoke colorblindness to oppose affirmative action, DEI, or anti-racism initiatives — arguing racism is solved or that addressing race is itself racist — while ignoring evidence of ongoing structural discrimination in hiring, housing, lending, and policing.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'colorblind_racism')}`,
  },
  {
    ...
    researchPrompt: `Use the research tool to find articles, opinion pieces, and online content that frame immigration as a deliberate attempt to "replace" or "dilute" the white population — whether using explicit replacement theory language or softer framing like "demographic change" as civilizational threat.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'great_replacement')}`,
  },
  {
    ...
    researchPrompt: `Use the research tool to find articles and opinion pieces defending Confederate monuments, the Confederate flag, or the "Lost Cause" narrative — arguing the Civil War wasn't primarily about slavery, framing Confederate statues as heritage rather than propaganda, or romanticizing the antebellum South.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'confederate_apologia')}`,
  },
  ...
  // ── Misogyny & Gender Discrimination ────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find content that frames women as adversaries to manipulate, argues for male dominance in relationships as natural, dehumanizes women through "sexual market value" language, or promotes strategies to coerce or manipulate women — packaged as dating advice, men's self-improvement, or men's rights content.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'redpill_misogyny')}`,
  },
  {
    key: 'pay_gap_denial',
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'pay_gap_denial')}`,
  },
  ...
  // ── LGBTQ+ Discrimination ────────────────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find articles, think-tank pieces, and news content that uses "groomer" rhetoric, "protect women's spaces" framing, or "protect children" framing to target trans people — without evidence of the claimed harms — or that promotes anti-trans legislation based on manufactured moral panic.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'trans_panic')}`,
  },
  {
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'conversion_therapy')}`,
  },
  ...
  // ── Environmental Harm ───────────────────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find articles, think-tank content, and op-eds that deny climate change, minimize its severity, attack climate scientists, or manufacture delay by arguing action is premature, too costly, or technologically impossible — often funded by or reflecting fossil fuel industry interests.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'greenwashing')}`,
  },
  ...
  // ── Health Misinformation ────────────────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find articles, websites, and social media content that spreads false information about vaccine safety or efficacy — using fabricated studies, misrepresented data, celebrity testimonials over evidence, or conspiracy framing about pharmaceutical companies suppressing harm data.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'vaccine_disinfo')}`,
  },
  {
    ...
    researchPrompt: `Use the research tool to find websites and content that market scientifically unsupported alternative treatments to vulnerable people — particularly cancer patients, autoimmune patients, or parents of sick children — with false efficacy claims, cherry-picked testimonials, and attacks on evidence-based medicine.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'alt_medicine_scams')}`,
  },
  ...
  // ── Authoritarian & Anti-Democratic ─────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find articles, op-eds, and policy advocacy that support voter ID laws, voter roll purges, polling place closures, or other restrictions on voting access — framed as "election integrity" measures despite no evidence of significant voter fraud and documented disproportionate impact on minority voters.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'voter_suppression')}`,
  },
  {
    ...
    researchPrompt: `Use the research tool to find articles and commentary that uncritically admire Putin, Orbán, Xi, or similar authoritarian leaders as effective or admirable — or that argue Western democracies need stronger executive power, reduced judicial oversight, or "temporary" suspension of democratic norms for efficiency.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'autocrat_admiration')}`,
  },
  ...
  // ── Surveillance & Privacy ───────────────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find articles and op-eds that normalize or advocate for mass surveillance — using "nothing to hide" reasoning, arguing surveillance improves safety without acknowledging chilling effects, or defending corporate data harvesting as a fair exchange for free services without engaging with consent, power, or abuse issues.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'surveillance_normalization')}`,
  },
  ...
  // ── Criminal Justice Bias ────────────────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find articles and op-eds that minimize documented police brutality, defend individual officers in cases of clear misconduct, oppose police accountability measures using "bad apples" or "few bad actors" framing, or frame any criticism of policing as an attack on public safety.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'police_apologia')}`,
  },
  {
    key: 'prison_labor',
    name: 'Prison Labor Normalization',
    description: 'Content defending or normalizing the exploitation of incarcerated workers',
    researchPrompt: `Use the research tool to find articles and content that defend prison labor programs paying near-zero wages, frame forced prison labor as "rehabilitation," or oppose efforts to pay incarcerated workers minimum wage — including corporate sourcing from prison labor presented neutrally or positively.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'prison_labor')}`,
  },
  ...
  // ── Propaganda & Media Manipulation ─────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find journalism and commentary that creates false equivalence between parties or positions with dramatically different factual groundings — treating fringe climate denial as equivalent to scientific consensus, equating minor Democratic and major Republican norm violations, or presenting "both sides" on settled empirical questions.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'false_equivalence')}`,
  },
  {
    ...
    researchPrompt: `Use the research tool to find think-tank reports, op-eds, and policy papers from organizations funded by fossil fuel, pharmaceutical, tobacco, or other industries — presented as independent expert analysis without disclosure of conflicts of interest, used to argue against regulation that would harm funders.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'think_tank_astroturfing')}`,
  },
  ...
  // ── Tech Harms ───────────────────────────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find articles and industry-funded research that minimize or deny the documented links between social media use and depression, anxiety, and self-harm in adolescents — or that argue platforms have no responsibility for addictive design patterns.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'social_media_addiction_defense')}`,
  },
  {
    ...
    researchPrompt: `Use the research tool to find articles that dismiss AI safety concerns as sci-fi hysteria, frame AI ethics work as obstructing progress, minimize documented harms from biased AI systems in hiring or criminal justice, or argue AI companies should be free from regulation.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'ai_ethics_dismissal')}`,
  },
  ...
  // ── Colonialism & Imperialism ────────────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find articles, op-eds, and academic adjacent content that frame colonialism as a net positive for colonized peoples, minimize documented atrocities, argue colonialism "built infrastructure," or suggest former colonies should be grateful — while dismissing economic extraction, cultural destruction, and lasting inequality.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'colonialism_revisionism')}`,
  },
  {
    ...
    researchPrompt: `Use the research tool to find articles and policy advocacy that oppose indigenous land rights, tribal sovereignty, sacred site protections, or treaty rights — using "all Americans are equal" colorblind framing, resource extraction arguments, or dismissal of indigenous cultural and spiritual claims.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'indigenous_rights_denial')}`,
  },
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'christian_nationalism')}`,
  },
  ...
  // ── Ableism ──────────────────────────────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find content that frames disability accommodations as excessive burden, opposes ADA enforcement, portrays disabled people as inherently less productive or valuable, or uses disability as a rhetorical weapon (e.g., calling opponents "mentally ill" as insult, mocking physical disability).
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'ableism')}`,
  },
  ...
  // ── Meritocracy Myth ─────────────────────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find op-eds, business commentary, and think-tank pieces that insist the US is a pure meritocracy where anyone can succeed through hard work — while ignoring inheritance, legacy admissions, social capital, racial wealth gaps, redlining effects, and documented hiring discrimination.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'meritocracy_myth')}`,
  },
  ...
  // ── Dark Money & Regulatory Capture ─────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find articles and op-eds that defend Citizens United and unlimited dark money in politics as purely free speech — without engaging with documented corruption, regulatory capture, or the drowning out of ordinary voters' interests by billionaire donors.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'dark_money_normalization')}`,
  },
  ...
  // ── Islamophobia & Xenophobia ─────────────────────────────────────────────────
  {
    ...
    researchPrompt: `Use the research tool to find articles and opinion content that frame all Muslims or Islam itself as inherently violent, hold Muslim communities collectively responsible for terrorist attacks, advocate for Muslim surveillance or travel bans using sweeping religious generalizations, or promote "Islam is incompatible with democracy" arguments.
...
${JSON_SCHEMA.replace('<CATEGORY_KEY>', 'islamophobia')}`,
  },
];

export function getBatch(index: number, size: number = 3): Category[] {
  const start = (index * size) % CATEGORIES.length;
