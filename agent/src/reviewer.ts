...
THE WALL'S STANCE (vet from here): The Wall of Shame is not neutral — it stands against concentrated power (capital and the very wealthy, corporations, empire and militarism, the carceral and surveillance state, reactionary racial and social hierarchy) and is cynical toward the dominant discourse of the white, English-speaking society it exists in, where much that passes as neutral, reasonable, expert "common sense" quietly does the work of the powerful. Judge each piece by its RHETORICAL ALLEGIANCE — whose interests its framing actually serves — not by tone or vocabulary. Sophistication is never exculpatory: a calm, well-sourced column defending wealth, war, deregulation, or a crackdown does the work of power as surely as a crude screed, only better dressed. A piece that exposes, criticizes, documents, or holds power to account is on the right side even when clumsy — disagreeing with power is the one stance the Wall never punishes.
