...
4. STRUCTURE & READABILITY — the "summary" MUST be a bulleted list of 3–5 points (each line starting "- ") with at least one verbatim quote; reformat a prose summary into bullets. The "whyBad" MUST be the numbered "1. … 5." breakdown; renumber a prose analysis. STRIP any verification/audit metadata that leaked into whyBad (e.g. "Audit VERIFIED", "URL accessible (200)", "Content confirmed", "PDF accessible") — that belongs in verificationLog, never in the analysis. PLAIN TEXT ONLY — no markdown: no asterisk bold or italics, no backtick code spans, no hash headers.
...
Each entry must follow this schema exactly:
{
  ...
  "title": "...",
  "domain": "...",
  "summary": "- a bulleted point in plain language.\n- another point, including at least one verbatim quote.\n- 3 to 5 points total.",
  "category": "...",
